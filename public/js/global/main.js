  ...
  var App = {
    ...
    isnitializeMaps: function(element, lat, lng) {
      ...
      var ctMaps = '<div class="map-marker">';
          ctMaps += '<h3>Mode Quality Services Inc.</h3>';
          ctMaps +=  '<p class="p-desc">';
          ctMaps +=   '<img src="/public/images/local.jpg" alt="">';
          ctMaps +=    '<span>957 North Plum Grove Road, Suite A, Schaumburg, IL 60173</span>';
          ctMaps +=  '</p>';
          ctMaps +=  '<p class="p-desc">';
          ctMaps +=    '<img src="/public/images/phone.jpg" alt="">';
          ctMaps +=    '<span>(224) 509-4113</span>';
          ctMaps +=  '</p>';
          ctMaps +=  '<p class="p-desc">';
          ctMaps +=    '<img src="/public/images/widgets-icon_12.jpg" alt="">';
          ctMaps +=    '<span>(855) 422-9855</span>';
          ctMaps +=  '</p>';
          ctMaps +=  '<p class="p-desc">';
          ctMaps +=    '<img src="/public/images/mail.png" alt="">';
          ctMaps +=    '<span>modequalityservices@gmail.com</span>';
          ctMaps +=  '</p>';
          ctMaps +=  '<p class="p-desc hours">';
          ctMaps +=   '<img src="/public/images/hours.jpg" alt="">';
          ctMaps +=    '<span>Mon-Sat: 7:00am - 9:00pm Sun: 9:00am - 5:00pm</span>';
          ctMaps +=  '</p>';
          ctMaps +=  '<div class="marker">';
          ctMaps +=    '<img src="/public/images/uploads/free/hands-map.png" alt="">';
          ctMaps +=  '</div>';
          ctMaps +='</div>';
